...
class Rectangles:
    ...
    def __init__(self):
        ...
        self.levels[0] = [
            (352, 185, 128, 175, 0, 0, False, False),
        ...
        self.levels[5] = [
            (153, 329, 173, 30, 0, 0, False, False),
...
class Platform:
    ...
    def __init__(
        self, x, y, width, height, slope=False, slip=False, support=False, snow=False
    ):
