...
class Babe(King):
    ...
    def __init__(self, screen, levels):
        ...
        self.level = self.levels.max_level - 1
    ...
    def _check_ending(self, king):
        ...
        if True:
            ...
            if abs(self.rect_x - king.rect_x) <= self.ending_distance:

                self.levels.ending = True

                king.rect_x, king.rect_y = (
                    self.rect_x - self.ending_distance,
                    self.rect_y,
                )
